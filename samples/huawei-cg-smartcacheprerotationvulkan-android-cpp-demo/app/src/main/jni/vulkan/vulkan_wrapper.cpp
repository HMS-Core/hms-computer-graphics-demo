...
void InitVulkanInstance(void* libvulkan)
{
...
void InitVulkanPipeline(void* libvulkan)
{
...
void InitVulkanCmd(void* libvulkan)
{
...
int InitVulkan(void)
{
    ...
    InitVulkanInstance(libvulkan);
    InitVulkanCmd(libvulkan);
    InitVulkanPipeline(libvulkan);
